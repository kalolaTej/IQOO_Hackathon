    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-2 border-b border-slate-200">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-2xl font-black text-[#0f172a] tracking-tight">Pre-Harvest Protection & Intrusion Summary</h1>
        ...
        <button
          ...
          disabled={refreshing}
          className="px-3.5 py-2 bg-white border border-slate-200 text-[#0f172a] text-xs font-bold rounded-xl hover:bg-slate-50 transition-colors shadow-2xs flex items-center gap-1.5 cursor-pointer w-fit"
        >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="p-4 bg-white rounded-2xl border border-slate-200 shadow-2xs space-y-1">
          ...
          <div className="text-2xl font-black text-red-700 font-data-tabular">
            {stats.activeAlerts} Threats
          </div>
          <Link to="/alerts" className="text-[11px] text-red-700 font-bold hover:underline flex items-center gap-1">
        ...
        <div className="p-4 bg-white rounded-2xl border border-slate-200 shadow-2xs space-y-1">
          ...
          <Link to="/protect/incidents" className="text-[11px] text-[#047857] font-bold hover:underline flex items-center gap-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-xs space-y-3">
          ...
          <div className="divide-y divide-slate-100 text-xs">
            {recentDetections.map((d, i) => (
              <div key={d.id || i} className="py-2.5 flex items-center justify-between gap-3">
                <div>
                  <div className="flex items-center gap-2">
                    <strong className="text-[#0f172a] capitalize">{d.animal}</strong>
                  ...
                  <span className="text-[11px] text-slate-500 block mt-0.5">{d.zone} • {d.time}</span>
                </div>
        ...
        <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-xs space-y-3">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            ...
            <Link to="/protect/animals" className="text-xs text-[#047857] font-bold hover:underline">
              Target Settings →
            </Link>
          </div>
          ...
          <div className="space-y-3 text-xs pt-1">
            <div>
              <div className="flex justify-between mb-1 font-bold text-[#0f172a]">
                <span>Wild Boar / Pig (Most Detected)</span>
                <span className="font-black text-[#047857]">64% (18 Events)</span>
              </div>
            ...
            <div>
              <div className="flex justify-between mb-1 font-bold text-[#0f172a]">
                <span>Cow / Stray Cattle</span>
                <span className="font-black text-slate-700">25% (7 Events)</span>
              </div>
              <div className="w-full bg-slate-100 h-2.5 rounded-full overflow-hidden">
            ...
            <div>
              <div className="flex justify-between mb-1 font-bold text-[#0f172a]">
                <span>Horse / Nilgai</span>
                <span className="font-black text-slate-700">11% (3 Events)</span>
              </div>
              <div className="w-full bg-slate-100 h-2.5 rounded-full overflow-hidden">
