      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-slate-200">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-2xl font-black text-[#0f172a] tracking-tight">My Produce Lots & OpenCV Quality Grading</h1>
          ...
          <p className="text-xs text-slate-600 mt-1 font-medium">
            Real crop image capture, OpenCV computer vision quality classification, and automated mandi selling advisories.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2.5">
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-[#047857] hover:bg-[#065f46] text-white text-xs font-black transition-all shadow-md active:scale-95 cursor-pointer"
          >
            <Camera size={15} />
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-2.5 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 text-xs font-bold transition-colors shadow-2xs cursor-pointer"
          >
              ...
              >
                <div>
                  ...
                  <div className="relative aspect-video bg-slate-950 overflow-hidden">
                    ...
                    />
                    <div className="absolute top-3 left-3 bg-slate-900/85 backdrop-blur-md px-2.5 py-1 rounded-lg text-white font-mono text-[10px] font-bold border border-slate-700">
                      {b.id}
                    </div>

                    {/* Quality Grade Stamp */}
                    <div className="absolute top-3 right-3 flex items-center gap-1.5 bg-white/95 backdrop-blur-md px-3 py-1 rounded-xl shadow-md border border-slate-200">
                    ...
                    <div className="absolute bottom-2 left-3 right-3 bg-slate-950/80 backdrop-blur-md px-3 py-1.5 rounded-lg text-slate-200 text-[11px] flex items-center justify-between border border-slate-800">
                      <span>
                        Quality Score: <strong className="text-emerald-400 font-bold">{qualityScore}/100</strong>
                      </span>
                      <span>
                        NIR Moisture: <strong className="text-white font-bold">{b.moisture || '11.0%'}</strong>
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="p-5 space-y-3">
                    <div className="flex items-center justify-between">
                      <h2 className="text-lg font-black text-[#0f172a]">{cropName}</h2>
                ...
                <div className="p-5 pt-0 border-t border-slate-100 flex items-center justify-between gap-2 pt-3">
                  <div className="flex items-center gap-1.5">
                    ...
                    <Link
                      ...
                      className="px-3.5 py-2 bg-[#047857] hover:bg-[#065f46] text-white rounded-xl text-xs font-black shadow-md transition-colors flex items-center gap-1 cursor-pointer"
                    >
                      <span>Advisory</span>
                      <ArrowRight size={13} />
                    </Link>
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 max-w-lg w-full border border-slate-200 shadow-2xl space-y-5 my-8">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h2 className="text-base font-black text-[#0f172a]">Add Produce with OpenCV Quality Inspection</h2>
                  <p className="text-[11px] text-slate-500">Capture real crop photo for automated grading</p>
                </div>
              </div>
              <button
                onClick={() => {
            ...
            <form onSubmit={handleSubmitProduce} className="space-y-4 text-xs">
              {/* Crop Selection */}
              <div>
              ...
              <div className="space-y-2 pt-1">
                ...
                {cameraActive ? (
                  <div className="relative rounded-2xl overflow-hidden bg-slate-950 aspect-video flex items-center justify-center border border-slate-800">
                    ...
                    <div className="absolute bottom-3 left-0 right-0 flex justify-center gap-3">
                      <button
                        ...
                        className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-extrabold shadow-lg flex items-center gap-1.5 cursor-pointer"
                      >
                        <Camera size={14} />
                      ...
                      <button
                        type="button"
                        onClick={stopCamera}
                        className="px-3 py-2 bg-slate-800 text-white rounded-xl font-bold cursor-pointer"
                      >
                        Cancel
                      </button>
                    </div>
                  ...
                  <div className="relative rounded-2xl overflow-hidden bg-slate-950 aspect-video border border-slate-200">
                    ...
                    <div className="absolute bottom-3 right-3 flex gap-2">
                      <button
                        type="button"
                        onClick={startCamera}
                        className="px-3 py-1.5 bg-slate-900/80 backdrop-blur-md text-white rounded-lg text-xs font-bold hover:bg-slate-800 cursor-pointer"
                      >
                        Retake
                      </button>
                    </div>
                  ...
                  <div className="border-2 border-dashed border-slate-300 rounded-2xl p-6 text-center space-y-3 bg-[#fafafa]">
                    <div className="w-12 h-12 rounded-full bg-emerald-50 text-[#047857] flex items-center justify-center mx-auto">
                      <Camera size={24} />
                    </div>
                    <div>
                      <p className="font-extrabold text-slate-800">Capture or Upload Real Crop Photo</p>
                      <p className="text-[11px] text-slate-500 mt-0.5">Open device camera or select a local crop photo for OpenCV inspection.</p>
                    </div>
                    <div className="flex justify-center gap-3 pt-1">
                      <button
                        type="button"
                        onClick={startCamera}
                        className="px-4 py-2 bg-[#047857] text-white rounded-xl font-extrabold hover:bg-[#065f46] transition-colors flex items-center gap-1.5 shadow-sm cursor-pointer"
                      >
                        <Camera size={14} />
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-white text-slate-700 border border-slate-200 rounded-xl font-bold hover:bg-slate-50 transition-colors flex items-center gap-1.5 cursor-pointer"
                      >
                        <Upload size={14} />
              ...
              <div className="pt-3 flex items-center justify-end gap-2 border-t border-slate-100">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="px-5 py-2.5 bg-[#047857] text-white font-extrabold rounded-xl hover:bg-[#065f46] shadow-md transition-all flex items-center gap-1.5 disabled:opacity-50 cursor-pointer"
                >
                  {submitting ? (
                    <>
      ...
      {selectedAnalysisLot && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto animate-fade-in">
          <div className="bg-white rounded-3xl p-6 sm:p-8 max-w-lg w-full border border-slate-200 shadow-2xl space-y-5 my-8">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h2 className="text-base font-black text-[#0f172a]">
                    OpenCV Quality Analysis: {selectedAnalysisLot.crop || selectedAnalysisLot.crop_type}
                  </h2>
                  <p className="text-[11px] text-slate-500">Batch #{selectedAnalysisLot.id}</p>
                </div>
              </div>
              <button
            ...
            <div className="relative aspect-video rounded-2xl overflow-hidden bg-slate-950 border border-slate-200">
              <img
                src={getImageUrl(
                  activeImageTab === 'annotated'
              ...
              />
              <div className="absolute bottom-2 left-3 bg-slate-900/80 backdrop-blur-md px-2.5 py-1 rounded-lg text-slate-200 text-[10px] font-mono">
                {activeImageTab === 'annotated' ? 'OpenCV HUD Overlay Active' : 'Unprocessed Source Capture'}
              </div>
            </div>

            {/* Defect Specific Metrics Bar */}
            <div className="grid grid-cols-3 gap-2 text-center text-xs">
              <div className="p-2.5 bg-red-50/70 border border-red-100 rounded-2xl">
                <span className="text-[10px] font-bold text-red-600 uppercase block">Defect Ratio</span>
                ...
                <span className="text-[9px] text-slate-500 block">of Produce ROI</span>
              </div>

              <div className="p-2.5 bg-amber-50/70 border border-amber-100 rounded-2xl">
                <span className="text-[10px] font-bold text-amber-600 uppercase block">Defect Blobs</span>
                ...
                <span className="text-[9px] text-slate-500 block">Lesions Detected</span>
              </div>
              ...
              <div className="p-2.5 bg-slate-50 border border-slate-200 rounded-2xl">
                ...
                <span className="text-[9px] text-slate-500 block">Weighted Vision Index</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 text-xs">
              <div className="p-3 bg-[#f8fafc] rounded-2xl border border-slate-100 space-y-1">
                <span className="text-slate-500 font-bold">Color Health</span>
              ...
              <div className="p-3 bg-[#f8fafc] rounded-2xl border border-slate-100 space-y-1">
                <span className="text-slate-500 font-bold">Surface Integrity</span>
                <div className="text-lg font-black text-[#0f172a]">
              ...
              <div className="p-3 bg-[#f8fafc] rounded-2xl border border-slate-100 space-y-1">
                <span className="text-slate-500 font-bold">Shape Symmetry</span>
                <div className="text-lg font-black text-[#0f172a]">
              ...
              <div className="p-3 bg-[#f8fafc] rounded-2xl border border-slate-100 space-y-1">
                <span className="text-slate-500 font-bold">Color Uniformity</span>
                <div className="text-lg font-black text-[#0f172a]">
            ...
            {/* Quality Notes */}
            <div className="p-4 bg-[#0f172a] text-white rounded-2xl text-xs space-y-1.5">
            ...
            <div className="flex items-center justify-between pt-2 border-t border-slate-100">
              <button
                ...
                className="text-xs text-[#047857] font-bold hover:underline flex items-center gap-1 cursor-pointer"
              >
                <RefreshCw size={13} />
                <span>Re-run OpenCV Grading</span>
              </button>

              <button
                onClick={() => setSelectedAnalysisLot(null)}
                className="px-4 py-2 bg-slate-100 text-slate-800 font-bold rounded-xl text-xs hover:bg-slate-200 cursor-pointer"
              >
                Close Analysis
              </button>
            </div>
